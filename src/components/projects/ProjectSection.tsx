        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-12 md:gap-4 sm:gap-6">
              ...
              <div className="flex flex-col md:flex-row justify-between gap-4 sm:gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-3 text-[15px] sm:text-[15px] lg:text-[16px] text-[#cfd6e6] leading-[1.8]">
                    Advanced AI-driven insights platform utilizing RAG (Retrieval-Augmented
                    Generation) and vector search to provide context-aware data interpretations
                ...
                <div className="w-full md:w-[260px] lg:w-[270px] shrink-0 bg-[#1b2438] border border-cyan-300/20 rounded-md p-4">
                  ...
                  <p className="mt-2 text-[14px] sm:text-[15px] lg:text-[16px] text-cyan-200 leading-[1.5]">
                    Hybrid RAG + Vector DB for 99.9% Context Retrieval
                  </p>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="space-y-3 text-[14px] sm:text-[15px] lg:text-[16px] text-[#cfd6e6]">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <span>LLM Orchestration with LangChain</span>
                    </div>

                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="mt-[2px] shrink-0 text-cyan-300 w-4 h-4" />
                      <span>Real-time Semantic Data Search</span>
                    </div>

                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="mt-[2px] shrink-0 text-cyan-300 w-4 h-4" />
                      <span>Customizable AI Dashboard Widgets</span>
                    </div>
          ...
          <div className="md:col-span-4 rounded-2xl overflow-hidden border border-white/10 bg-[#131b2e] transition-all duration-300 hover:border-cyan-300/20">
            ...
            <div className="p-5 sm:p-6">
              ...
              <p className="mt-2 text-[13px] sm:text-[14px] leading-[1.7] text-[#cfd6e6]">
                High-concurrency storefront with Go backend and Kubernetes orchestration for auto-scaling.
              </p>
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <div className="mt-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <TechTagSmall text="Go" />
                    <TechTagSmall text="PostgreSQL" />
                    <TechTagSmall text="Kubernetes" />
                  </div>
                </div>
              </div>
          ...
          <div className="md:col-span-4 rounded-2xl overflow-hidden border border-white/10 bg-[#131b2e] transition-all duration-300 hover:border-cyan-300/20">
            ...
            <div className="p-5 sm:p-6">
              ...
              {/* DESCRIPTION */}
              <p className="mt-2 text-[13px] sm:text-[14px] leading-[1.7] text-[#cfd6e6]">
                Secure API gateway platform engineered with zero-trust architecture,
                intelligent rate limiting, and enterprise-grade authentication systems.
              </p>
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <div className="mt-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <TechTagSmall text="Rust" />
                    <TechTagSmall text="Redis" />
                    <TechTagSmall text="Kong" />
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3 text-[11px] sm:text-[13px]">
                ...
                <a
                  href="#"
                  className="flex items-center gap-2 font-semibold text-sm text-cyan-300 hover:text-[#dae2fd]"
                >
                  <Rocket className="w-4 h-4" />
                  <span>Live Demo</span>
                </a>
                ...
                <a
                  href="#"
                  className="flex items-center gap-2 font-semibold text-sm text-[#8b90a0] hover:text-[#dae2fd]"
                >
                  <Code2 className="w-4 h-4" />
                  <span>Frontend Repo</span>
                </a>
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-8 p-8 md:p-10 h-full min-h-[340px] sm:min-h-[420px]">
              ...
              <div className="w-full md:w-1/2 flex flex-col justify-center">
                ...
                <p className="mt-5 max-w-[540px] text-[14px] sm:text-[15px] lg:text-[16px] leading-[1.8] text-[#6f778b]">
                  Currently architecting a distributed AI training pipeline for decentralized datasets.
                  Stay tuned for the technical deep-dive and infrastructure breakdown covering scalable
                  model orchestration, GPU scheduling, and federated intelligence systems.
                </p>

                {/* ACTION BUTTON */}
                <Link href="/contact">
                  <button
                    className={`${jetbrainsMono.className} mt-8 w-fit self-start rounded-sm border border-white/10 bg-[#1b2438] px-4 sm:px-5 py-2.5 sm:py-3 text-[11px] sm:text-[12px] uppercase tracking-[0.12em] text-[#b7c6e6] transition-all duration-300 hover:border-cyan-300/30 hover:bg-[#202c46] hover:text-cyan-200`}
                  >
                    Notify_Me
                  </button>
                </Link>
